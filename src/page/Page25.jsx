...
import Image1 from '../asset/our gallery/induction/image (1).jpeg'
import Image2 from '../asset/our gallery/induction/image (2).jpeg'
import Image3 from '../asset/our gallery/induction/image (3).jpeg'
import Image4 from '../asset/our gallery/induction/image (4).jpeg'
import Image5 from '../asset/our gallery/induction/image (5).jpeg'
import Image6 from '../asset/our gallery/induction/image (6).jpeg'
        ...
        <div style={{ backgroundColor: '#f0f0f0', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.4)', marginTop: '100px' }} className="col-md-9 p-4 mx-auto text-center">
          <div className="row justify-content-center">
            <div className="col-md-12 text-center">
              <h2>PSE Induction Programme 2026</h2>
            </div>
          </div>
          <div className="row justify-content-around">
            ...
            <div className="col-md-4 text-center mb-3">
              <img src={Image3} alt="Image 3" className="img-fluid rounded border p-3" style={{ maxHeight: '300px', maxWidth: '100%', height: '210px', marginLeft:'-100px'   }} />
            </div>
            <div className="col-md-4 text-center mb-3">
            ...
            <div className="col-md-4 text-center mb-3">
              <img src={Image6} alt="Image5" className="img-fluid rounded border p-3" style={{ maxHeight: '300px', maxWidth: '100%' , height: '210px', marginLeft:'-200px'}} />
            </div>
